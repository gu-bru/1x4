(function () {
    ...
    //UNITY STUFF
    var buildUrl = "Build";
    var loaderUrl = buildUrl + "/1x4.loader.js";
    var config = {
        dataUrl: buildUrl + "/1x4.data",
        frameworkUrl: buildUrl + "/1x4.framework.js",
        codeUrl: buildUrl + "/1x4.wasm",
        streamingAssetsUrl: "StreamingAssets",
        companyName: "G. Brunbauer",
        productName: "1x4 - Übung mit Spaß",
        productVersion: "2.16 1.7.2023",
    };
